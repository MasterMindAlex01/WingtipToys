...
public class NVPAPICaller
{
    ...
    public string APIUsername = "alex.rodriguez-facilitator_api1.misena.edu.co";
    private string APIPassword = "MTZ3KMD5PXH4VFX5";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31Auizno2c-DXKpBgihJLWa-bCW0v8";
